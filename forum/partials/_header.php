<?php
// include("partials/_dbconnect.php"); already fixed inside the index.php on line no. 17 18
session_start();

    echo '<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <a class="navbar-brand" href="/forum">Nerd\'s Way</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item dropdown">
          ...
          $sql = "select category_name, category_id from categories LIMIT 3";  //now only 3 categories will show due to LIMIT 
